...
# 2 "<built-in>" 2
# 1 "LCD_Control_Main.c" 2
# 12 "LCD_Control_Main.c"
...
void LCD_PrintScreen(char *);
# 15 "LCD_Control_Main.c" 2
...
# 58 "LCD_Control_Main.c"
void InitPic(void);
void AllLedBlink(void);
void UsartInit(void);
void Usart_Data(uint8_t);
void Usart_PrintScreen(char *);
...
void Usart_Data(uint8_t data)
{
    while (PIR1bits.TXIF == 0){__nop();};
            TXREG = data;
...
uint8_t Usart_Read(void)
{
    ...
    while (PIR1bits.RCIF == 0){__nop();}
    uint8_t data = RCREG;
    return(data);

}
# 269 "LCD_Control_Main.c"
void Usart_PrintScreen(char *data)
{
    while (*data != '\0')
    {
        Usart_Data(*data);
...
# 303 "LCD_Control_Main.c"
    ...
    SSPSTATbits.CKE = 1;
# 320 "LCD_Control_Main.c"
    SSPCON2bits.SEN = 0;
# 332 "LCD_Control_Main.c"
    SSPSTATbits.CKE = 1;
# 358 "LCD_Control_Main.c"
    SSPCON1bits.SSPEN = 1;
}
